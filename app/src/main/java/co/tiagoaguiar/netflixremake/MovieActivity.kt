...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    private lateinit var txtTitle: TextView   // variaveis de campo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=f92bf6ec-fb8d-4dbf-b7c8-fa7a13e38a31"
